...
- Prize eligibility requires: open-sourcing all code and added data (GNU GPLv3 on the Challenge GitHub), documenting any open external datasets used, sufficient docs to reproduce, and an original solution (reuse allowed only with rights and meaningful modifications).
...
All public eligible final repository forks are live on the [PRC Data Challenge 2025 GitHub page](https://github.com/prc-data-challenge-2025). For more information on the final ranking criteria and eligibility see [here](https://ansperformance.eu/study/data-challenge/dc2025/ranking.html).  
:::
...
To get an overview of the competition, the plot below shows how team rankings moved during the final phase of the challenge.
...
Lower scores reflect better performance; note the shifts as teams iterate.

## RMSE spotlights

Inspired by an exchange with team [genuine-zucchini](teams/genuine-zucchini.qmd),
below are refreshed RMSE histories for five teams. They highlight where big swings happened during the final phase.
