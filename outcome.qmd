...
Uses METAR and passenger stats, and SkyVector for extra airport info.
Estimates TOW.
Nice domain specific features.
Perturbed training data with 5-15% gaussian noise for widebody aircraft types.
Python code is well organized and commented.



### wise-watermelon, RMSE = 350.98, Rank = 12
Just 2 python notebooks.
No comments...sigh.
