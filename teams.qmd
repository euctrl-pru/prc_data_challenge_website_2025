...
ccc <- teams_valid |> 
  ...
  write_csv("data/teams_country@6.csv")
...
```{r cumulative-plot-ggg, echo=FALSE, warning=FALSE, error=TRUE, message=FALSE}
...
teams_country = FileAttachment('data/teams_country@6.csv').csv({ typed: true })
...
```{r teams-bar-ggg, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, eval=TRUE}
library(countrycode)
library(scales)
