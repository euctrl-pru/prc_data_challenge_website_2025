...
ccc <- teams_valid |> 
  ...
  write_csv("data/teams_country@5.csv")
...
```{r cumulative-plot-fff, echo=FALSE, warning=FALSE, error=TRUE, message=FALSE}
...
teams_country = FileAttachment('data/teams_country@5.csv').csv({ typed: true })
...
```{r teams-bar-fff, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, eval=TRUE}
library(countrycode)
library(scales)
