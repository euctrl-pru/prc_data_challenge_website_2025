...
```{r cumulative-plot-lessly, echo=FALSE, warning=FALSE, error=TRUE, message=FALSE}
...
```{r teams-bar-lessly, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, eval=TRUE}
library(countrycode)
library(scales)
