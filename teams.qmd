...
ccc <- teams_valid |> 
  ...
  write_csv("data/teams_country@8.csv")
...
```{r cumulative-plot-iii, echo=FALSE, warning=FALSE, error=TRUE, message=FALSE}
...
teams_country = FileAttachment('data/teams_country@8.csv').csv({ typed: true })
...
```{r teams-bar-iii, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, eval=TRUE}
library(countrycode)
library(scales)
