...
ccc <- teams_valid |> 
  ...
  write_csv("data/teams_country@4.csv")
...
```{r cumulative-plot-ddd, echo=FALSE, warning=FALSE, error=TRUE, message=FALSE}
...
teams_country = FileAttachment('data/teams_country@4.csv').csv({ typed: true })
...
```{r teams-bar-ddd, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, eval=TRUE}
library(countrycode)
library(scales)
