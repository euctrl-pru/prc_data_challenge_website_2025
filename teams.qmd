...
ccc <- teams_valid |> 
  ...
  write_csv("data/teams_country@2.csv")
...
```{r cumulative-plot-bbb, echo=FALSE, warning=FALSE, error=TRUE, message=FALSE}
...
teams_country = FileAttachment('data/teams_country@2.csv').csv({ typed: true })
...
```{r teams-bar-bbb, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, eval=TRUE}
library(countrycode)
library(scales)
