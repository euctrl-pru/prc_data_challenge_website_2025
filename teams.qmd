...
ccc <- teams_valid |> 
  ...
  write_csv("data/teams_country@3.csv")
...
```{r cumulative-plot-ccc, echo=FALSE, warning=FALSE, error=TRUE, message=FALSE}
...
teams_country = FileAttachment('data/teams_country@3.csv').csv({ typed: true })
...
```{r teams-bar-ccc, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, eval=TRUE}
library(countrycode)
library(scales)
