...
ccc <- teams_valid |> 
  ...
  write_csv(here::here("data", "teams_country@27.csv"))
...
```{r cumulative-plot-bb, echo=FALSE, warning=FALSE, error=TRUE, message=FALSE}
...
teams_country = FileAttachment('../data/teams_country@27.csv').csv({ typed: true })
...
```{r teams-bar-bb, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, eval=TRUE}
