...
ccc <- teams_valid |> 
  ...
  write_csv(here::here("data", "teams_country@21.csv"))
...
```{r cumulative-plot-vvv, echo=FALSE, warning=FALSE, error=TRUE, message=FALSE}
...
teams_country = FileAttachment('../data/teams_country@21.csv').csv({ typed: true })
...
```{r teams-bar-vvv, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, eval=TRUE}
