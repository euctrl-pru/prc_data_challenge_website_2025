...
ccc <- teams_valid |> 
  ...
  write_csv(here::here("data", "teams_country@24.csv"))
...
```{r cumulative-plot-yyy, echo=FALSE, warning=FALSE, error=TRUE, message=FALSE}
...
teams_country = FileAttachment('../data/teams_country@24.csv').csv({ typed: true })
...
```{r teams-bar-yyy, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, eval=TRUE}
