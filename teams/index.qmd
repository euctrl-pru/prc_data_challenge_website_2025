...
ccc <- teams_valid |> 
  ...
  write_csv(here::here("data", "teams_country@34.csv"))
...
```{r cumulative-plot-ii, echo=FALSE, warning=FALSE, error=TRUE, message=FALSE}
...
teams_country = FileAttachment('../data/teams_country@34.csv').csv({ typed: true })
...
```{r teams-bar-ii, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, eval=TRUE}
