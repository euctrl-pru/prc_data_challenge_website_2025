...
ccc <- teams_valid |> 
  ...
  write_csv(here::here("data", "teams_country@22.csv"))
...
```{r cumulative-plot-zzz, echo=FALSE, warning=FALSE, error=TRUE, message=FALSE}
...
teams_country = FileAttachment('../data/teams_country@22.csv').csv({ typed: true })
...
```{r teams-bar-zzz, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, eval=TRUE}
