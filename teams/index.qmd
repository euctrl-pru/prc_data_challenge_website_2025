...
ccc <- teams_valid |> 
  ...
  write_csv(here::here("data", "teams_country@12.csv"))
...
```{r cumulative-plot-mmm, echo=FALSE, warning=FALSE, error=TRUE, message=FALSE}
...
teams_country = FileAttachment('/data/teams_country@12.csv').csv({ typed: true })
...
```{r teams-bar-mmm, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, eval=TRUE}
library(countrycode)
library(scales)
