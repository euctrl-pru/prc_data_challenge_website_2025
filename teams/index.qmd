...
ccc <- teams_valid |> 
  ...
  write_csv(here::here("data", "teams_country@38.csv"))
...
```{r cumulative-plot-mm, echo=FALSE, warning=FALSE, error=TRUE, message=FALSE}
...
teams_country = FileAttachment('../data/teams_country@38.csv').csv({ typed: true })
...
```{r teams-bar-mm, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, eval=TRUE}
