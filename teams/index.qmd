...
ccc <- teams_valid |> 
  ...
  write_csv(here::here("data", "teams_country@41.csv"))
...
```{r cumulative-plot-pp, echo=FALSE, warning=FALSE, error=TRUE, message=FALSE}
...
teams_country = FileAttachment('../data/teams_country@41.csv').csv({ typed: true })
...
```{r teams-bar-pp, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, eval=TRUE}
