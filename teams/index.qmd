...
ccc <- teams_valid |> 
  ...
  write_csv(here::here("data", "teams_country@52.csv"))
...
```{r cumulative-plot-a1, echo=FALSE, warning=FALSE, error=TRUE, message=FALSE}
...
teams_country = FileAttachment('../data/teams_country@52.csv').csv({ typed: true })
