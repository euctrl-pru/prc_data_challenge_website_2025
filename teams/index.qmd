...
ccc <- teams_valid |> 
  ...
  write_csv(here::here("data", "teams_country@19.csv"))
...
```{r cumulative-plot-ttt, echo=FALSE, warning=FALSE, error=TRUE, message=FALSE}
...
teams_country = FileAttachment('../data/teams_country@19.csv').csv({ typed: true })
...
```{r teams-bar-ttt, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, eval=TRUE}
