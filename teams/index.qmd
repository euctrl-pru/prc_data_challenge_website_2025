...
ccc <- teams_valid |> 
  ...
  write_csv(here::here("data", "teams_country@28.csv"))
...
```{r cumulative-plot-cc, echo=FALSE, warning=FALSE, error=TRUE, message=FALSE}
...
teams_country = FileAttachment('../data/teams_country@28.csv').csv({ typed: true })
...
```{r teams-bar-cc, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, eval=TRUE}
