...
ccc <- teams_valid |> 
  ...
  write_csv(here::here("data", "teams_country@20.csv"))
...
```{r cumulative-plot-uuu1, echo=FALSE, warning=FALSE, error=TRUE, message=FALSE}
...
teams_country = FileAttachment('../data/teams_country@20.csv').csv({ typed: true })
...
```{r teams-bar-uuu, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, eval=TRUE}
