...
ccc <- teams_valid |> 
  ...
  write_csv(here::here("data", "teams_country@23.csv"))
...
```{r cumulative-plot-xxx, echo=FALSE, warning=FALSE, error=TRUE, message=FALSE}
...
teams_country = FileAttachment('../data/teams_country@23.csv').csv({ typed: true })
...
```{r teams-bar-xxx, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, eval=TRUE}
