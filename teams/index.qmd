...
ccc <- teams_valid |> 
  ...
  write_csv(here::here("data", "teams_country@26.csv"))
...
```{r cumulative-plot-aa, echo=FALSE, warning=FALSE, error=TRUE, message=FALSE}
...
teams_country = FileAttachment('../data/teams_country@26.csv').csv({ typed: true })
...
```{r teams-bar-aa, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, eval=TRUE}
