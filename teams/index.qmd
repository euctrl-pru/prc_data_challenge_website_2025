...
ccc <- teams_valid |> 
  ...
  write_csv(here::here("data", "teams_country@29.csv"))
...
```{r cumulative-plot-dd, echo=FALSE, warning=FALSE, error=TRUE, message=FALSE}
...
teams_country = FileAttachment('../data/teams_country@29.csv').csv({ typed: true })
...
```{r teams-bar-dd, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, eval=TRUE}
