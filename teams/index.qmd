...
ccc <- teams_valid |> 
  ...
  write_csv(here::here("data", "teams_country@49.csv"))
...
```{r cumulative-plot-xx, echo=FALSE, warning=FALSE, error=TRUE, message=FALSE}
...
teams_country = FileAttachment('../data/teams_country@49.csv').csv({ typed: true })
...
```{r teams-bar-xx, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, eval=TRUE}
