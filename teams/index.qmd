...
ccc <- teams_valid |> 
  ...
  write_csv(here::here("data", "teams_country@40.csv"))
...
```{r cumulative-plot-oo, echo=FALSE, warning=FALSE, error=TRUE, message=FALSE}
...
teams_country = FileAttachment('../data/teams_country@40.csv').csv({ typed: true })
...
```{r teams-bar-oo, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, eval=TRUE}
