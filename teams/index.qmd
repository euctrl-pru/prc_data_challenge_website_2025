...
ccc <- teams_valid |> 
  ...
  write_csv(here::here("data", "teams_country@50.csv"))
...
```{r cumulative-plot-yy, echo=FALSE, warning=FALSE, error=TRUE, message=FALSE}
...
teams_country = FileAttachment('../data/teams_country@50.csv').csv({ typed: true })
...
```{r teams-bar-yy, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, eval=TRUE}
