...
ccc <- teams_valid |> 
  ...
  write_csv(here::here("data", "teams_country@62.csv"))
...
```{r cumulative-plot-b2, echo=FALSE, warning=FALSE, error=TRUE, message=FALSE}
...
teams_country = FileAttachment('../data/teams_country@62.csv').csv({ typed: true })
