...
ccc <- teams_valid |> 
  ...
  write_csv(here::here("data", "teams_country@44.csv"))
...
```{r cumulative-plot-ss, echo=FALSE, warning=FALSE, error=TRUE, message=FALSE}
...
teams_country = FileAttachment('../data/teams_country@44.csv').csv({ typed: true })
...
```{r teams-bar-ss, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, eval=TRUE}
