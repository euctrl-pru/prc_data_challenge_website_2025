...
ccc <- teams_valid |> 
  ...
  write_csv(here::here("data", "teams_country@60.csv"))
...
```{r cumulative-plot-b0, echo=FALSE, warning=FALSE, error=TRUE, message=FALSE}
...
teams_country = FileAttachment('../data/teams_country@60.csv').csv({ typed: true })
...
```{r teams-bar-b0, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, eval=TRUE}
