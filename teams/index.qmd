...
ccc <- teams_valid |> 
  ...
  write_csv(here::here("data", "teams_country@45.csv"))
...
```{r cumulative-plot-tt, echo=FALSE, warning=FALSE, error=TRUE, message=FALSE}
...
teams_country = FileAttachment('../data/teams_country@45.csv').csv({ typed: true })
...
```{r teams-bar-tt, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, eval=TRUE}
