...
```{r cumulative-plot-sss1, echo=FALSE, warning=FALSE, error=TRUE, message=FALSE}
#| fig-cap: !expr paste("Cumulative count of team creation, 2025 in", colorize('black'), "some are", colorize('blue'), ", 2024 in", colorize("grey"))
