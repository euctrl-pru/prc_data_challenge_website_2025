...
ccc <- teams_valid |> 
  ...
  write_csv(here::here("data", "teams_country@32.csv"))
...
```{r cumulative-plot-gg, echo=FALSE, warning=FALSE, error=TRUE, message=FALSE}
...
teams_country = FileAttachment('../data/teams_country@32.csv').csv({ typed: true })
...
```{r teams-bar-gg, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, eval=TRUE}
