...
ccc <- teams_valid |> 
  ...
  write_csv(here::here("data", "teams_country@43.csv"))
...
```{r cumulative-plot-rr, echo=FALSE, warning=FALSE, error=TRUE, message=FALSE}
...
teams_country = FileAttachment('../data/teams_country@43.csv').csv({ typed: true })
...
```{r teams-bar-rr, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, eval=TRUE}
