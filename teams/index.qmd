...
ccc <- teams_valid |> 
  ...
  write_csv(here::here("data", "teams_country@30.csv"))
...
```{r cumulative-plot-ee, echo=FALSE, warning=FALSE, error=TRUE, message=FALSE}
...
teams_country = FileAttachment('../data/teams_country@30.csv').csv({ typed: true })
...
```{r teams-bar-ee, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, eval=TRUE}
