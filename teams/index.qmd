...
ccc <- teams_valid |> 
  ...
  write_csv(here::here("data", "teams_country@51.csv"))
...
```{r cumulative-plot-ww, echo=FALSE, warning=FALSE, error=TRUE, message=FALSE}
...
teams_country = FileAttachment('../data/teams_country@51.csv').csv({ typed: true })
...
```{r teams-bar-ww, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, eval=TRUE}
