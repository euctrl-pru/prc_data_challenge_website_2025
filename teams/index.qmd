...
ccc <- teams_valid |> 
  ...
  write_csv(here::here("data", "teams_country@59.csv"))
...
```{r cumulative-plot-a9, echo=FALSE, warning=FALSE, error=TRUE, message=FALSE}
...
teams_country = FileAttachment('../data/teams_country@59.csv').csv({ typed: true })
...
```{r teams-bar-a9, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, eval=TRUE}
