...
ccc <- teams_valid |> 
  ...
  write_csv(here::here("data", "teams_country@47.csv"))
...
```{r cumulative-plot-vv, echo=FALSE, warning=FALSE, error=TRUE, message=FALSE}
...
teams_country = FileAttachment('../data/teams_country@47.csv').csv({ typed: true })
...
```{r teams-bar-uu, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, eval=TRUE}
