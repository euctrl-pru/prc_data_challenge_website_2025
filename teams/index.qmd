...
ccc <- teams_valid |> 
  ...
  write_csv(here::here("data", "teams_country@42.csv"))
...
```{r cumulative-plot-qq, echo=FALSE, warning=FALSE, error=TRUE, message=FALSE}
...
teams_country = FileAttachment('../data/teams_country@42.csv').csv({ typed: true })
...
```{r teams-bar-qq, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, eval=TRUE}
