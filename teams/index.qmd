...
ccc <- teams_valid |> 
  ...
  write_csv(here::here("data", "teams_country@46.csv"))
...
```{r cumulative-plot-uu, echo=FALSE, warning=FALSE, error=TRUE, message=FALSE}
...
teams_country = FileAttachment('../data/teams_country@46.csv').csv({ typed: true })
