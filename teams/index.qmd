...
ccc <- teams_valid |> 
  ...
  write_csv(here::here("data", "teams_country@13.csv"))
...
```{r cumulative-plot-nnn, echo=FALSE, warning=FALSE, error=TRUE, message=FALSE}
...
teams_country = FileAttachment('../data/teams_country@13.csv').csv({ typed: true })
...
```{r teams-bar-nnn, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, eval=TRUE}
library(countrycode)
library(scales)
