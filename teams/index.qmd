...
ccc <- teams_valid |> 
  ...
  write_csv(here::here("data", "teams_country@61.csv"))
...
```{r cumulative-plot-b1, echo=FALSE, warning=FALSE, error=TRUE, message=FALSE}
...
teams_country = FileAttachment('../data/teams_country@61.csv').csv({ typed: true })
...
```{r teams-bar-b1, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, eval=TRUE}
