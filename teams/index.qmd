...
ccc <- teams_valid |> 
  ...
  write_csv(here::here("data", "teams_country@55.csv"))
...
```{r cumulative-plot-a5, echo=FALSE, warning=FALSE, error=TRUE, message=FALSE}
...
teams_country = FileAttachment('../data/teams_country@55.csv').csv({ typed: true })
...
```{r teams-bar-a5, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, eval=TRUE}
