...
ccc <- teams_valid |> 
  ...
  write_csv(here::here("data", "teams_country@35.csv"))
...
```{r cumulative-plot-jj, echo=FALSE, warning=FALSE, error=TRUE, message=FALSE}
...
```{r teams-bar-jj, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, eval=TRUE}
