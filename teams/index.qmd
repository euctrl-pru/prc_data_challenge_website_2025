...
```{r cumulative-plot-sss2, echo=FALSE, warning=FALSE, error=TRUE, message=FALSE}
#| fig-cap: !expr paste("Cumulative count of team creation, 2025 in", colorize('black'), ", 2024 in", colorize("grey"))
