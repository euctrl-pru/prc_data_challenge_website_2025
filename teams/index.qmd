...
ccc <- teams_valid |> 
  ...
  write_csv(here::here("data", "teams_country@33.csv"))
...
```{r cumulative-plot-hh, echo=FALSE, warning=FALSE, error=TRUE, message=FALSE}
...
teams_country = FileAttachment('../data/teams_country@33.csv').csv({ typed: true })
...
```{r teams-bar-hh, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, eval=TRUE}
