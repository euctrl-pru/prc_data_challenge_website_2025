...
ccc <- teams_valid |> 
  ...
  write_csv(here::here("data", "teams_country@31.csv"))
...
```{r cumulative-plot-ff, echo=FALSE, warning=FALSE, error=TRUE, message=FALSE}
...
teams_country = FileAttachment('../data/teams_country@31.csv').csv({ typed: true })
...
```{r teams-bar-ff, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, eval=TRUE}
