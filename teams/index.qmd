...
ccc <- teams_valid |> 
  ...
  write_csv(here::here("data", "teams_country@48.csv"))
...
```{r cumulative-plot-zz, echo=FALSE, warning=FALSE, error=TRUE, message=FALSE}
...
teams_country = FileAttachment('../data/teams_country@48.csv').csv({ typed: true })
...
```{r teams-bar-zz, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, eval=TRUE}
