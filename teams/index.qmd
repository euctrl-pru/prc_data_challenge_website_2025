...
ccc <- teams_valid |> 
  ...
  write_csv(here::here("data", "teams_country@25.csv"))
...
```{r cumulative-plot-www, echo=FALSE, warning=FALSE, error=TRUE, message=FALSE}
...
teams_country = FileAttachment('../data/teams_country@25.csv').csv({ typed: true })
...
```{r teams-bar-www, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, eval=TRUE}
