...
ccc <- teams_valid |> 
  ...
  write_csv(here::here("data", "teams_country@58.csv"))
...
```{r cumulative-plot-a8, echo=FALSE, warning=FALSE, error=TRUE, message=FALSE}
...
teams_country = FileAttachment('../data/teams_country@58.csv').csv({ typed: true })
...
```{r teams-bar-a8, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, eval=TRUE}
