...
ccc <- teams_valid |> 
  ...
  write_csv(here::here("data", "teams_country@39.csv"))
...
```{r cumulative-plot-nn, echo=FALSE, warning=FALSE, error=TRUE, message=FALSE}
...
teams_country = FileAttachment('../data/teams_country@39.csv').csv({ typed: true })
...
```{r teams-bar-nn, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, eval=TRUE}
