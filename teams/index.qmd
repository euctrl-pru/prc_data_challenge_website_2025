...
ccc <- teams_valid |> 
  ...
  write_csv(here::here("data", "teams_country@37.csv"))
...
```{r cumulative-plot-ll, echo=FALSE, warning=FALSE, error=TRUE, message=FALSE}
...
teams_country = FileAttachment('../data/teams_country@37.csv').csv({ typed: true })
...
```{r teams-bar-ll, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, eval=TRUE}
